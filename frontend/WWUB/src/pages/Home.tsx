  ...
  return (
    <div className="text-center py-10">
      ...
      <p className="text-lg text-gray-700 leading-relaxed max-w-2xl mx-auto">
        Discover your potential and embark on a journey of continuous learning and personal
        development. We provide tools and resources to help you explore various paths and grow into
