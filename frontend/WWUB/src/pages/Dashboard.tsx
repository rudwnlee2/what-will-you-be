...
const DashboardPage: React.FC = () => {
  return (
    // 최상위 div에서 max-w-4xl mx-auto 제거
    <div className="py-10 text-center">
      ...
      <p className="text-lg text-gray-700 leading-relaxed">
        This is where your personalized journey unfolds. Here, you'll find your
        progress, recommended learning paths, and tools to track your
        development.
      </p>
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-purple-50 p-6 rounded-lg shadow-inner">
          ...
          <p className="text-gray-600">
            Discover and develop new competencies.
          </p>
        </div>
