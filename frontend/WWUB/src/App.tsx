...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-200 p-8 text-gray-800 flex flex-col items-center">
      {/* 헤더 섹션 */}
      ...
      <nav className="mb-12 flex justify-center space-x-8 w-full">
        <Link
          to="/"
      ...
      <main className=" p-8 bg-white rounded-xl shadow-2xl w-full ">
